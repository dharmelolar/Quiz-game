  ...
  var op4=document.getElementById('op4');
      ...
      var app={
                questions:[
                          ...
                          {q:'Which of these is not used to declare variables in javascript?',options:['var','let','const','All of these'],answer:4},
                          {q:'Which of these is not a CSS property?',options:['Animation','scale','Transform','Transition',],answer:2}
                          ],
                index:0,
                load:function(){
